...
(function(){
    ...
    ProductForm.prototype = Object.assign({}, ProductForm.prototype, {
      addItemFromForm: function(evt, callback){
        ...
        .then(function(data) {
          ...
          $('.add-to-cart.btn--loading').removeClass('btn--loading');
  ...
  theme.HeaderSection = (function() {
    ...
    HeaderSection.prototype = Object.assign({}, HeaderSection.prototype, {
      ...
      initDrawers2: function() {
        theme.NavDrawer2 = new theme.Drawers('NavDrawer2', 'nav');
        // if (theme.settings.cartType === 'drawer') {
        //   if (!document.body.classList.contains('template-cart')) {
        //     new theme.CartDrawer();
        //   }
        ...
        theme.collapsibles.init(document.getElementById('NavDrawer2'));
      },
  
      initDrawers3: function() {
        theme.NavDrawer3 = new theme.Drawers('NavDrawer3', 'nav');
        // if (theme.settings.cartType === 'drawer') {
        //   if (!document.body.classList.contains('template-cart')) {
        //     new theme.CartDrawer();
        //   }
        ...
        theme.collapsibles.init(document.getElementById('NavDrawer3'));
      },
      onBlockSelect: function(evt) {
      ...
      onUnload: function() {
        ...
        theme.NavDrawer2.close();
        theme.NavDrawer3.close();
...
$(document).on("click",".collection-jackets-section .add-to-cart",function () {

  $(this).addClass('btn--loading');
 
  var data = $(this).parents('.product-single__form').serialize();   
  ...
  $.ajax({
    ...
    success: function(){
       ...
       $('.add-to-cart.btn--loading').removeClass('btn--loading');
          ...
          $('html').addClass('js-drawer-open cart-js-drawer-open');   
    },
    error: function(){
 console.log('error');	
    }
...
$(document).on("click","div#CartDrawer .drawer__close-button,.cart-js-drawer-open",function (e) {
   e.preventDefault();
   $('#CartDrawer').removeClass('drawer--is-open');
        $('html').removeClass('js-drawer-open cart-js-drawer-open');
});

$(".drawer__inner,.drawer__title").on("click", function (e) {
     e.stopPropagation();
});
...
$(".box1").hover(
  function () { 
     $('.timeline-wrap').toggleClass("box1-hover");
  }
);
$(".box2").hover(
  function () {
    $('.timeline-wrap').toggleClass("box2-hover");
  }
);
$(".box3").hover(
  function () {
      $('.timeline-wrap').toggleClass("box3-hover");
  }
);

 $(document).on("click", '.adventure-product-section .product-single__meta .add-to-cart', function(e){       
    e.preventDefault();  
   $(this).addClass('btn--loading');
   $('.product-header .product-header-wrap .add-to-cart').trigger('click'); 
});
